...
//[GFN]---------------------------
        _gfnScaleXTop ("GFN Scale X Top", Float) = 3.0
        _gfnScaleXBottom("GFN Scale X Bottom", Float) = 1.0
        _gfnScaleXUpperMiddle("GFN Scale X Upper Middle", Float) = 3.0
        _gfnScaleXScaleMiddle("GFN Scale X Scale Middle", Float) = 2.0
        _gfnScaleXLowerMiddle("GFN Scale X Lower Middle", Float) = 1.0
        _gfnScaleXScaleZPlus("GFN Scale X Z Plus", Float) = 1.0
        _gfnScaleXScaleZMinus("GFN Scale X Z Minus", Float) = 1.0

        _gfnBendOnXTop("GFN Bend on X Top", Float) = 0.0
        _gfnBendOnXBottom("GFN Bend on X Bottom", Float) = 42.5
        _gfnBendOnXBottomJaw("GFN Bend on X Bottom Jaw", Float) = 25.07
        _gfnBendOnXUpperScale("GFN Bend on X Upper Scale", Float) = 1.0
        _gfnBendOnXLowerScale("GFN Bend on X Lower Scale", Float) = 0.35
        _gfnBendOnXUpperLoc("GFN Bend on X Upper Loc", Float) = -0.1
        _gfnBendOnXLowerLoc("GFN Bend on X Lower Loc", Float) = -0.1

        _gfnDebugMode("GFN Debug Mode", Int) = 0
        _gfnObjectCoordsTranslateX("GFN Object Coords Translate X", Float) = 0.0
        _gfnObjectCoordsTranslateY("GFN Object Coords Translate Y", Float) = -0.54
        _gfnObjectCoordsTranslateZ("GFN Object Coords Translate Z", Float) = 0.0
        _gfnObjectCoordsScaleX("GFN Object Coords Scale X", Float) = 8.0
        _gfnObjectCoordsScaleY("GFN Object Coords Scale Y", Float) = 8.0
        _gfnObjectCoordsScaleZ("GFN Object Coords Scale Z", Float) = 8.0
...
//            #pragma multi_compile_instancing
    ...
    CustomEditor "MToonSpecial.MToonSpecialInspector"
}

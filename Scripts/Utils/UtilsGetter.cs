    ...
    public static partial class Utils
    {
        public static MToonDefinition GetMToonParametersFromMaterial(Material material)
        {
            return new MToonDefinition
            {
                ...
                //[GFN]---------------------------
                GFN = new GenerateFaceNormalsDefinition
                {
                    gfnScaleXTop = GetValue(material, PropGFNScaleXTop),
                    gfnScaleXBottom = GetValue(material, PropGFNScaleXBottom),
                    gfnScaleXUpperMiddle = GetValue(material, PropGFNScaleXUpperMiddle),
                    gfnScaleXScaleMiddle = GetValue(material, PropGFNScaleXScaleMiddle),
                    gfnScaleXLowerMiddle = GetValue(material, PropGFNScaleXLowerMiddle),
                    gfnScaleXScaleZPlus = GetValue(material, PropGFNScaleXScaleZPlus),
                    gfnScaleXScaleZMinus = GetValue(material, PropGFNScaleXScaleZMinus),
                    gfnBendOnXTop = GetValue(material, PropGFNBendOnXTop),
                    gfnBendOnXBottom = GetValue(material, PropGFNBendOnXBottom),
                    gfnBendOnXBottomJaw = GetValue(material, PropGFNBendOnXBottomJaw),
                    gfnBendOnXUpperScale = GetValue(material, PropGFNBendOnXUpperScale),
                    gfnBendOnXLowerScale = GetValue(material, PropGFNBendOnXLowerScale),
                    gfnBendOnXUpperLoc = GetValue(material, PropGFNBendOnXUpperLoc),
                    gfnBendOnXLowerLoc = GetValue(material, PropGFNBendOnXLowerLoc),
                    gfnDebugMode = material.GetInt(PropGFNDebugMode),
                    gfnObjectCoordsTranslateX = GetValue(material, PropGFNObjectCoordsTranslateX),
                    gfnObjectCoordsTranslateY = GetValue(material, PropGFNObjectCoordsTranslateY),
                    gfnObjectCoordsTranslateZ = GetValue(material, PropGFNObjectCoordsTranslateZ),
                    gfnObjectCoordsScaleX = GetValue(material, PropGFNObjectCoordsScaleX),
                    gfnObjectCoordsScaleY = GetValue(material, PropGFNObjectCoordsScaleY),
                    gfnObjectCoordsScaleZ = GetValue(material, PropGFNObjectCoordsScaleZ),
                },
            };
        }

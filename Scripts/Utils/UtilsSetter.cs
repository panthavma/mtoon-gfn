...
namespace MToonSpecial
{
    public static partial class Utils
    {
        public static void SetMToonParametersToMaterial(Material material, MToonDefinition parameters)
        {
            ...
            //[GFN]---------------------------
            {
                var gfn = parameters.GFN;
                material.SetFloat(PropGFNScaleXTop, gfn.gfnScaleXTop);
                material.SetFloat(PropGFNScaleXBottom, gfn.gfnScaleXBottom);
                material.SetFloat(PropGFNScaleXUpperMiddle, gfn.gfnScaleXUpperMiddle);
                material.SetFloat(PropGFNScaleXScaleMiddle, gfn.gfnScaleXScaleMiddle);
                material.SetFloat(PropGFNScaleXLowerMiddle, gfn.gfnScaleXLowerMiddle);
                material.SetFloat(PropGFNScaleXScaleZPlus, gfn.gfnScaleXScaleZPlus);
                material.SetFloat(PropGFNScaleXScaleZMinus, gfn.gfnScaleXScaleZMinus);
                material.SetFloat(PropGFNBendOnXTop, gfn.gfnBendOnXTop);
                material.SetFloat(PropGFNBendOnXBottom, gfn.gfnBendOnXBottom);
                material.SetFloat(PropGFNBendOnXBottomJaw, gfn.gfnBendOnXBottomJaw);
                material.SetFloat(PropGFNBendOnXUpperScale, gfn.gfnBendOnXUpperScale);
                material.SetFloat(PropGFNBendOnXLowerScale, gfn.gfnBendOnXLowerScale);
                material.SetFloat(PropGFNBendOnXUpperLoc, gfn.gfnBendOnXUpperLoc);
                material.SetFloat(PropGFNBendOnXLowerLoc, gfn.gfnBendOnXLowerLoc);
                material.SetInt(PropGFNDebugMode, gfn.gfnDebugMode);
                material.SetFloat(PropGFNObjectCoordsTranslateX, gfn.gfnObjectCoordsTranslateX);
                material.SetFloat(PropGFNObjectCoordsTranslateY, gfn.gfnObjectCoordsTranslateY);
                material.SetFloat(PropGFNObjectCoordsTranslateZ, gfn.gfnObjectCoordsTranslateZ);
                material.SetFloat(PropGFNObjectCoordsScaleX, gfn.gfnObjectCoordsScaleX);
                material.SetFloat(PropGFNObjectCoordsScaleY, gfn.gfnObjectCoordsScaleY);
                material.SetFloat(PropGFNObjectCoordsScaleZ, gfn.gfnObjectCoordsScaleZ);
            }

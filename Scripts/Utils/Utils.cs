...
//[GFN]---------------------------
        public const string PropGFNScaleXTop = "_gfnScaleXTop";
        public const string PropGFNScaleXBottom = "_gfnScaleXBottom";
        public const string PropGFNScaleXUpperMiddle = "_gfnScaleXUpperMiddle";
        public const string PropGFNScaleXScaleMiddle = "_gfnScaleXScaleMiddle";
        public const string PropGFNScaleXLowerMiddle = "_gfnScaleXLowerMiddle";
        public const string PropGFNScaleXScaleZPlus = "_gfnScaleXScaleZPlus";
        public const string PropGFNScaleXScaleZMinus = "_gfnScaleXScaleZMinus";

        public const string PropGFNBendOnXTop = "_gfnBendOnXTop";
        public const string PropGFNBendOnXBottom = "_gfnBendOnXBottom";
        public const string PropGFNBendOnXBottomJaw = "_gfnBendOnXBottomJaw";
        public const string PropGFNBendOnXUpperScale = "_gfnBendOnXUpperScale";
        public const string PropGFNBendOnXLowerScale = "_gfnBendOnXLowerScale";
        public const string PropGFNBendOnXUpperLoc = "_gfnBendOnXUpperLoc";
        public const string PropGFNBendOnXLowerLoc = "_gfnBendOnXLowerLoc";

        public const string PropGFNDebugMode = "_gfnDebugMode";
        public const string PropGFNObjectCoordsTranslateX = "_gfnObjectCoordsTranslateX";
        public const string PropGFNObjectCoordsTranslateY = "_gfnObjectCoordsTranslateY";
        public const string PropGFNObjectCoordsTranslateZ = "_gfnObjectCoordsTranslateZ";
        public const string PropGFNObjectCoordsScaleX = "_gfnObjectCoordsScaleX";
        public const string PropGFNObjectCoordsScaleY = "_gfnObjectCoordsScaleY";
        public const string PropGFNObjectCoordsScaleZ = "_gfnObjectCoordsScaleZ";
//---------------------------------

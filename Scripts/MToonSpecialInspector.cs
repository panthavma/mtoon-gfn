...
{
    public class MToonSpecialInspector : ShaderGUI
    {
...
//[GFN]---------------------------
        private MaterialProperty _gfnScaleXTop;
        private MaterialProperty _gfnScaleXBottom;
        private MaterialProperty _gfnScaleXUpperMiddle;
        private MaterialProperty _gfnScaleXScaleMiddle;
        private MaterialProperty _gfnScaleXLowerMiddle;
        private MaterialProperty _gfnScaleXScaleZPlus;
        private MaterialProperty _gfnScaleXScaleZMinus;
        private MaterialProperty _gfnBendOnXTop;
        private MaterialProperty _gfnBendOnXBottom;
        private MaterialProperty _gfnBendOnXBottomJaw;
        private MaterialProperty _gfnBendOnXUpperScale;
        private MaterialProperty _gfnBendOnXLowerScale;
        private MaterialProperty _gfnBendOnXUpperLoc;
        private MaterialProperty _gfnBendOnXLowerLoc;
        private MaterialProperty _gfnDebugMode;
        private MaterialProperty _gfnObjectCoordsTranslateX;
        private MaterialProperty _gfnObjectCoordsTranslateY;
        private MaterialProperty _gfnObjectCoordsTranslateZ;
        private MaterialProperty _gfnObjectCoordsScaleX;
        private MaterialProperty _gfnObjectCoordsScaleY;
        private MaterialProperty _gfnObjectCoordsScaleZ;
...
//[GFN]---------------------------
            _gfnScaleXTop = FindProperty(Utils.PropGFNScaleXTop, properties);
            _gfnScaleXBottom = FindProperty(Utils.PropGFNScaleXBottom, properties);
            _gfnScaleXUpperMiddle = FindProperty(Utils.PropGFNScaleXUpperMiddle, properties);
            _gfnScaleXScaleMiddle = FindProperty(Utils.PropGFNScaleXScaleMiddle, properties);
            _gfnScaleXLowerMiddle = FindProperty(Utils.PropGFNScaleXLowerMiddle, properties);
            _gfnScaleXScaleZPlus = FindProperty(Utils.PropGFNScaleXScaleZPlus, properties);
            _gfnScaleXScaleZMinus = FindProperty(Utils.PropGFNScaleXScaleZMinus, properties);
            _gfnBendOnXTop = FindProperty(Utils.PropGFNBendOnXTop, properties);
            _gfnBendOnXBottom = FindProperty(Utils.PropGFNBendOnXBottom, properties);
            _gfnBendOnXBottomJaw = FindProperty(Utils.PropGFNBendOnXBottomJaw, properties);
            _gfnBendOnXUpperScale = FindProperty(Utils.PropGFNBendOnXUpperScale, properties);
            _gfnBendOnXLowerScale = FindProperty(Utils.PropGFNBendOnXLowerScale, properties);
            _gfnBendOnXUpperLoc = FindProperty(Utils.PropGFNBendOnXUpperLoc, properties);
            _gfnBendOnXLowerLoc = FindProperty(Utils.PropGFNBendOnXLowerLoc, properties);
            _gfnDebugMode = FindProperty(Utils.PropGFNDebugMode, properties);
            _gfnObjectCoordsTranslateX = FindProperty(Utils.PropGFNObjectCoordsTranslateX, properties);
            _gfnObjectCoordsTranslateY = FindProperty(Utils.PropGFNObjectCoordsTranslateY, properties);
            _gfnObjectCoordsTranslateZ = FindProperty(Utils.PropGFNObjectCoordsTranslateZ, properties);
            _gfnObjectCoordsScaleX = FindProperty(Utils.PropGFNObjectCoordsScaleX, properties);
            _gfnObjectCoordsScaleY = FindProperty(Utils.PropGFNObjectCoordsScaleY, properties);
            _gfnObjectCoordsScaleZ = FindProperty(Utils.PropGFNObjectCoordsScaleZ, properties);
...
//                    materialEditor.EnableInstancingField();
                ...
                //[GFN]---------------------------
                EditorGUILayout.LabelField("GenerateFaceNormals", EditorStyles.boldLabel);
                EditorGUILayout.BeginVertical(GUI.skin.box);
                {
                    // Object Coords
                    materialEditor.ShaderProperty(_gfnDebugMode, new GUIContent("Debug Mode", "0 Deactivated, 1 Object Coords, 2 Normals (Right Hand)"));
                    materialEditor.ShaderProperty(_gfnObjectCoordsTranslateX, new GUIContent("Object Coords : Translate X", "Test"));
                    materialEditor.ShaderProperty(_gfnObjectCoordsTranslateY, new GUIContent("Object Coords : Translate Y", "Test"));
                    materialEditor.ShaderProperty(_gfnObjectCoordsTranslateZ, new GUIContent("Object Coords : Translate Z", "Test"));
                    materialEditor.ShaderProperty(_gfnObjectCoordsScaleX, new GUIContent("Object Coords : Scale X", "Test"));
                    materialEditor.ShaderProperty(_gfnObjectCoordsScaleY, new GUIContent("Object Coords : Scale Y", "Test"));
                    materialEditor.ShaderProperty(_gfnObjectCoordsScaleZ, new GUIContent("Object Coords : Scale Z", "Test"));

                    // Scale X
                    materialEditor.ShaderProperty(_gfnScaleXTop, new GUIContent("GFN Scale X Top", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnScaleXBottom, new GUIContent("GFN Scale X Bottom", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnScaleXUpperMiddle, new GUIContent("GFN Scale X Upper Middle", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnScaleXScaleMiddle, new GUIContent("GFN Scale X Scale Middle", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnScaleXLowerMiddle, new GUIContent("GFN Scale X Lower Middle", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnScaleXScaleZPlus, new GUIContent("GFN Scale X Z Plus", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnScaleXScaleZMinus, new GUIContent("GFN Scale X Z Minus", "Same as Blender"));

                    // Bend on X
                    materialEditor.ShaderProperty(_gfnBendOnXTop, new GUIContent("GFN Bend on X Top", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnBendOnXBottom, new GUIContent("GFN Bend on X Bottom", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnBendOnXBottomJaw, new GUIContent("GFN Bend on X Bottom Jaw", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnBendOnXUpperScale, new GUIContent("GFN Bend on X Upper Scale", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnBendOnXLowerScale, new GUIContent("GFN Bend on X Lower Scale", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnBendOnXUpperLoc, new GUIContent("GFN Bend on X Upper Loc", "Same as Blender"));
                    materialEditor.ShaderProperty(_gfnBendOnXLowerLoc, new GUIContent("GFN Bend on X Lower Loc", "Same as Blender"));
